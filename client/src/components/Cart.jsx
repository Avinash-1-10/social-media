                ...
                >
                  ...
                  <div className="flex justify-center w-1/5">
                    <svg
                      ...
                      viewBox="0 0 448 512"
                      onClick={() => dispatch(subQuantity(product.product.id))}
                    >
                    ...
                    <svg
                      className="fill-current text-gray-600 w-3 cursor-pointer"
                      viewBox="0 0 448 512"
                      onClick={() => dispatch(addQuantity(product.product.id))}
                    >
            ...
            <div id="summary" className="w-full sm:w-1/4 px-4 sm:px-8 py-10">
              ...
              <div className="border-t mt-8">
                <div className="flex font-semibold justify-between py-6 text-sm uppercase">
                  ...
                  <span>${10 + Number(totalPrice.toFixed(2))}</span>
                </div>
                <button
                  className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full"
                  onClick={() =>
                    navigate("/checkout", {
                      state: { totalPrice: 10 + Number(totalPrice.toFixed(2)) },
                    })
                  }
                >
                  Checkout
